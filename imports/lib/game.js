...
import { Player } from './new_player1.js';
...
class Game {
    ...
    constructor(canvas, width, height) {
        ...
        this._player = new Player(this._ctx, this._width / 30, this._height / 4); // create a simple player
        this._player2 = new Player2(this._ctx, this._width / 30, this._height / 4);
    }
    ...
    play() {
        ...
        this._player2.draw(); // update player on each tick
